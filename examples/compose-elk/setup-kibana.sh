...
high_metric_payload='{
  "attributes": {
    ...
    "visState": "{\"title\":\"Pipeleek - High Hits\",\"type\":\"metrics\",\"params\":{\"id\":\"pipeleek-high-hits-panel\",\"type\":\"metric\",\"series\":[{\"id\":\"pipeleek-high-hits-series\",\"split_mode\":\"everything\",\"split_color_mode\":\"value\",\"metrics\":[{\"id\":\"pipeleek-high-hits-count\",\"type\":\"count\"}],\"label\":\"High Hits\",\"color\":\"#2A4A25\",\"formatter\":\"number\",\"chart_type\":\"line\",\"line_width\":\"1\",\"point_size\":\"1\",\"fill\":\"0.5\",\"value_template\":\"{{value}}\",\"color_rules\":[{\"id\":\"pipeleek-high-hits-color-rule\",\"operator\":\"gte\",\"value\":0,\"color\":\"#2A4A25\"}],\"background_color_rules\":[{\"id\":\"pipeleek-high-hits-bg-rule\",\"operator\":\"gte\",\"value\":0,\"color\":\"#2A4A25\"}],\"gauge_color_rules\":[{\"id\":\"pipeleek-high-hits-gauge-rule\",\"operator\":\"gte\",\"value\":0,\"color\":\"#2A4A25\"}]}],\"time_field\":\"@timestamp\",\"index_pattern\":\"pipeleek-logs-*\",\"default_index_pattern\":\"pipeleek-logs-*\",\"default_timefield\":\"@timestamp\",\"filter\":{\"language\":\"kuery\",\"query\":\"level:hit and confidence:high\"},\"interval\":\"auto\",\"time_range_mode\":\"entire_time_range\",\"isModelInvalid\":false}}",
    "uiStateJSON": "{}",
    "kibanaSavedObjectMeta": {
...
high_verified_metric_payload='{
  "attributes": {
    ...
    "visState": "{\"title\":\"Pipeleek - High-Verified Hits\",\"type\":\"metrics\",\"params\":{\"id\":\"pipeleek-high-verified-panel\",\"type\":\"metric\",\"series\":[{\"id\":\"pipeleek-high-verified-series\",\"split_mode\":\"everything\",\"split_color_mode\":\"value\",\"metrics\":[{\"id\":\"pipeleek-high-verified-count\",\"type\":\"count\"}],\"label\":\"High-Verified Hits\",\"color\":\"#D4821E\",\"formatter\":\"number\",\"chart_type\":\"line\",\"line_width\":\"1\",\"point_size\":\"1\",\"fill\":\"0.5\",\"value_template\":\"{{value}}\",\"color_rules\":[{\"id\":\"pipeleek-high-verified-color-rule\",\"operator\":\"gte\",\"value\":0,\"color\":\"#D4821E\"}],\"background_color_rules\":[{\"id\":\"pipeleek-high-verified-bg-rule\",\"operator\":\"gte\",\"value\":0,\"color\":\"#D4821E\"}],\"gauge_color_rules\":[{\"id\":\"pipeleek-high-verified-gauge-rule\",\"operator\":\"gte\",\"value\":0,\"color\":\"#D4821E\"}]}],\"time_field\":\"@timestamp\",\"index_pattern\":\"pipeleek-logs-*\",\"default_index_pattern\":\"pipeleek-logs-*\",\"default_timefield\":\"@timestamp\",\"filter\":{\"language\":\"kuery\",\"query\":\"level:hit and confidence:\\\"high-verified\\\"\"},\"interval\":\"auto\",\"time_range_mode\":\"entire_time_range\",\"isModelInvalid\":false}}",
    "uiStateJSON": "{}",
    "kibanaSavedObjectMeta": {
      "searchSourceJSON": "{\"query\":{\"language\":\"kuery\",\"query\":\"\"},\"filter\":[]}"
    }
...
hits_vs_artifacts_pie_payload='{
  "attributes": {
    ...
    "uiStateJSON": "{\"vis\":{\"colors\":{\"log\":\"#406B36\",\"artifact\":\"#D4821E\",\"archive\":\"#4A8FA8\",\"nested-archive\":\"#8B6BA8\",\"unknown\":\"#C4A035\",\"image\":\"#B9CF7E\",\"container\":\"#2A4A25\",\"registry\":\"#4A8FA8\",\"other\":\"#C4A035\"}}}",
    "kibanaSavedObjectMeta": {
...
ratings_pie_payload='{
  "attributes": {
    ...
    "uiStateJSON": "{\"vis\":{\"colors\":{\"high-verified\":\"#D4821E\",\"high\":\"#2A4A25\",\"medium\":\"#B9CF7E\",\"low\":\"#8B6BA8\",\"warning\":\"#C4A035\",\"informational\":\"#B9CF7E\",\"unknown\":\"#4A8FA8\"}}}",
    "kibanaSavedObjectMeta": {
      "searchSourceJSON": "{\"query\":{\"language\":\"kuery\",\"query\":\"level:hit\"},\"filter\":[],\"indexRefName\":\"kibanaSavedObjectMeta.searchSourceJSON.index\"}"
    }
  },
...
echo "Creating line chart for confidence hits over time..."
confidence_timeseries_payload='{
  "attributes": {
    "title": "Pipeleek - Hit Confidence Over Time",
    "description": "Hit count over time split by confidence",
    "visState": "{\"title\":\"Pipeleek - Hit Confidence Over Time\",\"type\":\"histogram\",\"params\":{\"addLegend\":true,\"addTooltip\":true,\"categoryAxes\":[{\"id\":\"CategoryAxis-1\",\"type\":\"category\",\"position\":\"bottom\",\"show\":true,\"style\":{},\"scale\":{\"type\":\"linear\"},\"labels\":{\"show\":true},\"title\":{\"text\":\"Time\"}}],\"valueAxes\":[{\"id\":\"ValueAxis-1\",\"name\":\"LeftAxis-1\",\"type\":\"value\",\"position\":\"left\",\"show\":true,\"style\":{},\"scale\":{\"type\":\"linear\",\"mode\":\"normal\"},\"labels\":{\"show\":true},\"title\":{\"text\":\"Hit Count\"}}],\"seriesParams\":[{\"show\":true,\"type\":\"line\",\"mode\":\"normal\",\"data\":{\"id\":\"1\",\"label\":\"Hit Count\"},\"valueAxis\":\"ValueAxis-1\",\"drawLinesBetweenPoints\":true,\"showCircles\":true,\"lineWidth\":2}],\"grid\":{\"categoryLines\":false,\"style\":{\"color\":\"#eee\"}},\"times\":[],\"addTimeMarker\":false,\"dimensions\":{\"x\":{\"accessor\":\"2\",\"format\":\"date\",\"params\":{}},\"y\":[{\"accessor\":\"1\",\"format\":{\"id\":\"number\"}}]}},\"aggs\":[{\"id\":\"1\",\"enabled\":true,\"type\":\"count\",\"schema\":\"metric\",\"params\":{}},{\"id\":\"2\",\"enabled\":true,\"type\":\"date_histogram\",\"schema\":\"segment\",\"params\":{\"field\":\"@timestamp\",\"useNormalizedEsInterval\":false,\"min_doc_count\":1,\"extended_bounds\":{},\"interval\":\"10m\",\"drop_partials\":false,\"time_zone\":\"UTC\"}},{\"id\":\"3\",\"enabled\":true,\"type\":\"terms\",\"schema\":\"group\",\"params\":{\"field\":\"confidence\",\"size\":10,\"order\":\"desc\",\"orderBy\":\"1\",\"missingBucket\":true,\"missingBucketLabel\":\"unknown\"}}]}",
    "uiStateJSON": "{\"vis\":{\"colors\":{\"high-verified\":\"#D4821E\",\"high\":\"#2A4A25\",\"medium\":\"#B9CF7E\",\"low\":\"#8B6BA8\",\"warning\":\"#C4A035\",\"informational\":\"#B9CF7E\",\"unknown\":\"#4A8FA8\"}}}",
    "kibanaSavedObjectMeta": {
      "searchSourceJSON": "{\"query\":{\"language\":\"kuery\",\"query\":\"level:hit\"},\"filter\":[],\"indexRefName\":\"kibanaSavedObjectMeta.searchSourceJSON.index\"}"
    }
...
upsert_saved_object "visualization" "pipeleek-vis-confidence-timeseries" "$confidence_timeseries_payload"

echo "Creating prebuilt dashboard..."
dashboard_payload='{
  "attributes": {
    "title": "Pipeleek - Hit Monitoring",
    "description": "High/high-verified counters, log intake over time, confidence trend over time, pie charts for hit distributions, latest 100 scan entries, and latest 100 raw log entries. Use dashboard filters for scan.platform and scan.confidence.",
    "hits": 0,
    "optionsJSON": "{\"useMargins\":true,\"hidePanelTitles\":false}",
    "panelsJSON": "[{\"type\":\"visualization\",\"panelIndex\":\"1\",\"gridData\":{\"x\":0,\"y\":0,\"w\":12,\"h\":8,\"i\":\"1\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_1\",\"version\":\"8.13.4\"},{\"type\":\"visualization\",\"panelIndex\":\"2\",\"gridData\":{\"x\":12,\"y\":0,\"w\":12,\"h\":8,\"i\":\"2\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_2\",\"version\":\"8.13.4\"},{\"type\":\"visualization\",\"panelIndex\":\"3\",\"gridData\":{\"x\":24,\"y\":0,\"w\":24,\"h\":8,\"i\":\"3\"},\"embeddableConfig\":{\"timeRange\":{\"from\":\"now-4h\",\"to\":\"now\"}},\"panelRefName\":\"panel_3\",\"version\":\"8.13.4\"},{\"type\":\"visualization\",\"panelIndex\":\"4\",\"gridData\":{\"x\":0,\"y\":8,\"w\":24,\"h\":12,\"i\":\"4\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_4\",\"version\":\"8.13.4\"},{\"type\":\"visualization\",\"panelIndex\":\"5\",\"gridData\":{\"x\":24,\"y\":8,\"w\":24,\"h\":12,\"i\":\"5\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_5\",\"version\":\"8.13.4\"},{\"type\":\"visualization\",\"panelIndex\":\"8\",\"gridData\":{\"x\":0,\"y\":20,\"w\":48,\"h\":10,\"i\":\"8\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_8\",\"version\":\"8.13.4\"},{\"type\":\"search\",\"panelIndex\":\"6\",\"gridData\":{\"x\":0,\"y\":30,\"w\":48,\"h\":12,\"i\":\"6\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_6\",\"version\":\"8.13.4\"},{\"type\":\"search\",\"panelIndex\":\"7\",\"gridData\":{\"x\":0,\"y\":42,\"w\":48,\"h\":12,\"i\":\"7\"},\"embeddableConfig\":{},\"panelRefName\":\"panel_7\",\"version\":\"8.13.4\"}]",
    "version": 1,
    "kibanaSavedObjectMeta": {
      "searchSourceJSON": "{\"query\":{\"language\":\"kuery\",\"query\":\"\"},\"filter\":[]}"
    }
  ...
  "references": [
    ...
    },
    {
      "name": "panel_8",
      "type": "visualization",
      "id": "pipeleek-vis-confidence-timeseries"
    },
    {
      "name": "panel_6",
      "type": "search",
